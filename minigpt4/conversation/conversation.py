...
class Chat:
    def __init__(self, model, vis_processor, task_id, device='cuda:0'):
    ...
    def upload_img(self, image, conv, img_list, task_id=None):
        ...
        image_emb, _, _ = self.model.encode_img(image)
